...
class Book(models.Model):
    ...
    def __str__(self):
        return f'Book #{self.pk}, genre: {self.book_genres}, author: {self.book_author}, book: {self.book_publisher}, code: {self.isbn_code}, price: {self.book_price}, amount: {self.books_amount}'
